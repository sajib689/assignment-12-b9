    ...
    <div className="flex flex-col items-center justify-center w-full max-w-sm mx-auto">
      ...
      <div className="w-56 -mt-10 overflow-hidden bg-white rounded-lg shadow-lg md:w-64 dark:bg-gray-800">
        ...
        <div className="flex items-center justify-between px-3 py-2 bg-gray-200 dark:bg-gray-700">
          ...
          <Link to={`/scholarShipDetails/${_id}`} className="px-2 py-1 text-xs font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
            Details
          </Link>
        </div>
      </div>
